...
To get started, install Node.js 22.12.0 or newer and npm 10.9.0 or newer. This repository currently builds against Electron 43. Clone this repository, cd into the NexusInterface directory, run `npm ci`, then run `npm run dev` and the dev server will spin up launching the app for you.
